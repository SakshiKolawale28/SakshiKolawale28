...
public class Jpr23 {
	...
	public static void main(String[] args) {
		...
		Student st1=new Student("sakshi","TYCO","C","22/8/2021","Sangola","mrunali@gmail.com",9658741203l);
		st1.admit();//admit student
		st1.changeAdd("pandhrpur");//change address
		st1.changeEmail("sakshi@gmail.com"); //change email
		st1.changeMob(9685374210);//change Mobile number
	}
